...
#define SYSTEM_PERIPHERAL_CLOCK (360000)
...
#ifndef TIMER_MAX_10US_CLIENTS
    #define TIMER_MAX_10US_CLIENTS 10
#endif
...
/* Variables *******************************************************/
static TICK_REQUEST requests[TIMER_MAX_10US_CLIENTS];
...
void TIMER_CancelTick(TICK_HANDLER handle)
{
    ...
    for(i = 0; i < TIMER_MAX_10US_CLIENTS; i++)
    {
